...
If you don't have a clue what to explect, you can create some visualizations of *d* to help determine the overlap between groups. You can create graphs with just the effect size or create a graph by entering some numbers you might expect for your study. This graph will help you visualize how much overlap two distributions have at various effect sizes. 
